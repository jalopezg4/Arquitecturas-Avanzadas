...
function tracingMiddleware(req, res, next) {
  ...
  // El gateway REENVIA el trace-id (y siembra uno si el cliente no lo trajo): asi un mismo request se sigue
  // desde el gateway hasta cada microservicio (HT-06). El proxy copia los encabezados de `req`.
